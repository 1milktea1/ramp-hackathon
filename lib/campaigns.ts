...
const SF_STAGE_2: QuestionSeed[] = [
  {
    ...
    device: "Ramp Ticker",
    prompt:
      "Prices [7, 1, 5, 3, 6]. Buy once, sell later. When you know the max gain, face the scanner and raise that many fingers.",
    aid: "delta-bars",
    answerText: "5",
    l1: "You must buy before you sell — order matters.",
    l2: "Find the lowest price, then the highest price that comes after it. Signal that digit with your hand.",
    sec: 50,
  },
  {
    id: "sf_unique_path_count",
    category: "logic",
    interaction: "camera",
    view: "center",
    device: "Courier Grid",
  ...
  },
  {
    ...
    device: "Log Wall",
    prompt:
      "Vault pattern (()()). Raise one finger if it is valid; otherwise raise fingers for the 0-based index of the first break.",
    answerText: "1",
    l1: "Walk the string once, tracking how many brackets are still open.",
    l2: "If the count never goes negative and ends at zero, it is balanced — signal 1.",
    sec: 50,
  },
];
...
const NY_STAGE_2: QuestionSeed[] = [
  {
    ...
    prompt:
      "A fair coin is flipped until it lands HEADS. Face the dial and raise fingers equal to the expected number of flips.",
    answerText: "2",
  ...
  },
  {
    ...
    prompt:
      "Bin holds 5 blue and 3 red. Draw 2 without replacement. P(both red) = ? / 28 — raise fingers for the numerator.",
    answerText: "3",
  ...
  },
  {
    ...
    device: "Three Vaults",
    prompt:
      "Three vaults, one prize. You pick one; a wrong vault is opened. Show an open palm to SWITCH, or a fist to STAY.",
    aid: "doors",
    answerText: "SWITCH",
    l1: "Your first pick was made when you knew nothing.",
    l2: "That first pick wins 1 in 3 of the time. All remaining odds sit on the other vault — open your palm.",
    sec: 45,
  },
];
